                ...
                <div class="col-12">
                    ...
                    <form id="editForm">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="horizontal-email-input" name="phone_number"
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12 d-flex justify-content-center align-content-center">
                                <button type="submadd-courseit" id="submitForm"
                                    class="btn btn-lg btn-register">{{ __('translation.Ok') }}</button>
                            </div>
                        </div>
                    </form>
                    <div class="row mb-4">
