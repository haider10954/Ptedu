                ...
                <div class="col-lg-12 table-responsive">
                    <table class="table align-middle mb-0 table-lectures border-white table-layout-fixed" id="myTable">
                        ...
                        <tr>
                            ...
                            <td class="align-middle t_header t-width-120">{{ __('translation.Buyer') }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <a onclick="delete_record('{{ $item->id }}')" class="btn btn-sm btn-danger"><i
                                                    class="bi bi-trash"></i></a>
                                            <a href="{{ route('view_payment',$item->id)}}"
                    ...
                    {{ $order->appends(request()->except('page'))->links('vendor.pagination.custom-pagination-admin') }}
                </div>
            </div>
        </div>
    </div>
