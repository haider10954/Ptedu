                    ...
                    <div class="col-12">
                        <div class="row mx-0">
                            ...
                            <div class="col-3">
                                <div class="d-flex align-items-center mb-3">
                                    @if($item->type == 'online')
                                        <h4 class="mb-sm-0  course_details">{{ ucfirst($item->course->course_type) }}
                                            Course</h4>
                                    @else
                                ...
                                <div class=" d-flex align-items-center mb-3">
                                    <h4 class="mb-sm-0  course_details">Total {{ $item->course->no_of_lectures }}
                                        Lecture</h4>
                                </div>
                                <div class=" d-flex align-items-center mb-3">
