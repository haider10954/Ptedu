...
@section('content')
                    ...
                    <table class="table align-middle table-nowrap mb-0  table-lectures border-white" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <td class="align-middle t_header">Live</td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ route('edit_course_view', $c->id) }}"><i
                                                        class="bi bi-pencil"></i></a>
                                                <a class="btn btn-sm btn-danger"
                                                    onclick="delete_record( '{{ $c->id }}')"><i
    ...
    {{-- Live Record --}}
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal fade" id="live-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Live Status</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form method="post" id="liveForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-3">
                                <label for="liveStatus">Status</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" id="liveFormBtn" class="btn btn-primary">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
