...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0  Card_title">{{ __('translation.Course List') }} >
                            {{ __('translation.Edit Course') }}</h4>
                    </div>
                    <hr class="hr-color" />
                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="courseForm" type="POST">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="horizontal-firstname-input"
                                                    placeholder="{{ __('translation.Enter Course Title') }}"
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Tutor Name') }}</label>
                                            <div class="col-sm-10">
                                                <select class="form-control" name="tutor_name">
                                                    <option value="">{{ __('translation.Select Option') }}</option>
                                                    @foreach ($tutor as $t)
                                                        <option value="{{ $t->id }}"
                                                            {{ $course->tutor_id == $t->id ? 'selected' : '' }}>
                                                            {{ $t->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Short Description') }}</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ __('translation.Enter Short Description') }}"
                                                    name="short_description" value="{{ $course->short_description }}">
                                                <div class="error-short-description"></div>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Description') }}</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="description" rows="2" placeholder="{{ __('translation.Enter description') }}"
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Total number of Lectures') }}</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control"
                                                    placeholder="{{ __('translation.Enter total number of lectures') }}"
                                                    name="no_of_lectures" value="{{ $course->no_of_lectures }}">
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Duration of the Course') }}</label>
                                            <div class="col-sm-10">
                                                <div class="row align-items-center">
                                                    <div class="col-sm-6">
                                                        <input type="number" class="form-control"
                                                            placeholder="{{ __('translation.Duration of the Course') }}"
                                                            name="course_duration"
                                                            value="{{ $course->duration_of_course }}">
                                        ...
                                        <div class="row">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Course Schedule') }}</label>
                                            <div class="col-sm-10">
                                                <div class="inner-repeater mb-4">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-success AddCourseSchedule">{{ __('translation.Add More') }}</button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Price') }}</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control"
                                                    placeholder="{{ __('translation.Enter Price') }}" name="price"
                                                    value="{{ $course->price }}">
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Discounted Price') }}</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control"
                                                    placeholder="{{ __('translation.Enter discounted Price') }}"
                                                    name="discounted_Price" value="{{ $course->discounted_prize }}">
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Category') }}</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Upload Video URL') }}</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ __('translation.Enter video URL ( Youtube or Vimeo )') }}"
                                                    name="video_url" value="{{ $course->video_url }}">
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Upload course Thumbnail image') }}
                                                <br> <span class="text-danger">{{ __('translation.Recommended size') }}
                                                    (840 * 580) </span> </label>
                                            <div class="col-sm-10">
                                                ...
                                                <div class="d-flex align-items-end">
                                                    <div class="course-image-preview" id="thumbnail_image_view">
                                                        <img style="height: 100%; object-fit: contain;"
                                                            ...
                                                            src="{{ asset('storage/course/thumbnail/' . $course->course_thumbnail) }}"
                                                            class="main_image_preview img-block- img-fluid w-100">
                                                    </div>
                                                    <button type="button" class="btn btn-upload ms-2"
                                                        onclick="courseImg('#course_img')">{{ __('translation.Upload') }}</button>
                                                </div>
                                                <div class="text-dark old_thumbnail_img_name">
                                                    <span
                                                        class="small badge bg-dark rounded-0">{{ $course->course_thumbnail }}</span>
                                                </div>
                                        ...
                                        <div class="row mb-4">
                                            <label
                                                class="col-sm-2 col-form-label lecture-form">{{ __('translation.Upload banner image') }}</label>
                                            <div class="col-sm-10">
                                                ...
                                                <div class="d-flex align-items-end">
                                                    <div class="course-image-preview" id="banner_image_view">
                                                        <img style="height: 100%; object-fit: contain;"
                                                            id="main_image_preview"
                                                            src="{{ asset('storage/course/banner/' . $course->course_banner) }}"
                                                            class="main_image_preview img-block- img-fluid w-100">
                                                    </div>
                                                    <button type="button" class="btn btn-upload ms-2"
                                                        onclick="courseImg('#banner_img')">{{ __('translation.Upload') }}</button>
                                                </div>
                                                <div class="text-dark old_thumbnail_img_name">
                                                    <span
                                                        class="small badge bg-dark rounded-0">{{ $course->course_banner }}</span>
                                                </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <button type="submit" id="submitForm"
                                                    class="btn btn-lg btn-register">{{ __('translation.Save') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12 mb-3 d-flex align-items-center justify-content-between">
                                            ...
                                            <button class="btn btn-primary btn-sm add_sections_btn"
                                                data-course-id="{{ $course->id }}"><i
                                                    class="fa fa-plus"></i>{{ __('translation.Add Sections') }}</button>
                                        </div>
                                        <div class="col-12">
                                                ...
                                                <tbody>
                                                    @foreach ($sections as $section)
                                                        <tr data-section-id="{{ $section->id }}">
                                                            <td>{{ $loop->index + 1 }}</td>
                                                            <td class="single_section_title">
                                                                {{ Str::limit($section->section_title, 30, '...') }}</td>
                                                            <td class="single_section_description">
                                                                {{ Str::limit($section->section_description, 50, '...') }}
                                                            </td>
                                                            <td class="d-flex gap-1">
                                                                <a href="javascript:void(0)"
                                                                    ...
                                                                    onclick="editSection({{ $section->id }},$(this))"
                                                                    class="btn btn-primary btn-sm editSectionBtn"><i
                                                                        class="bi bi-pencil"></i></a>
                                                                <a href="javascript:void(0)"
                                                                    class="btn btn-danger btn-sm del-section-btn"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#delSectionModal"
                                                                    data-del-id="{{ $section->id }}"
                                                                    data-course-id="{{ $section->course_id }}"><i
    ...
    @section('modals')
        <div class="modal fade" id="delSectionModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger"
                            id="delSectionBtn">{{ __('translation.Delete') }}</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="sectionTitle"
                                placeholder="{{ __('translation.Enter Section Title') }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="sectionDescription">{{ __('translation.Description') }}</label>
                            <textarea id="sectionDescription" class="form-control" cols="30" rows="5"
                                placeholder="{{ __('translation.Enter Section description') }}"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                        ...
                        <button type="button" class="btn btn-primary"
                            onclick="editSectionAction($(this))">{{ __('translation.Edit') }}</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="addSectionTitle" name="section_title"
                                placeholder="{{ __('translation.Enter Section Title') }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="addSectionDescription">{{ __('translation.Description') }}</label>
                            <textarea id="addSectionDescription" class="form-control" cols="30" rows="5"
                                placeholder="{{ __('translation.Enter Section description') }}"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success"
                            onclick="addSectionAction($(this))">{{ __('translation.Add More') }}</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form id="add_single_lecture_form">
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="add_lecture_title" name="lecture_title"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="add_lecture_video_link"
                                    name="lecture_video_link"
                                    placeholder="{{ __('translation.Add Lecture Video Link') }}">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
                            ...
                            <button type="submit" class="btn btn-success"
                                id="addLectureActionBtn">{{ __('translation.Add Lectures') }}</button>
                        </div>
                    </form>
                </div>
            </div>
        </div>
        <div class="modal fade" id="delLectureModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">{{ __('translation.Close') }}</button>
                        <button type="button" class="btn btn-danger"
                            onclick="delLectureAction($(this))">{{ __('translation.Delete') }}</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="deleteCourseScheduleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.success) {
                            ...
                            $('#sections-table tbody tr[data-section-id="' + $('#delSectionId').val() +
                                '"]').remove();
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.success) {
                            ...
                            $('#sections-table tbody tr[data-section-id="' + $('#editSectionId').val() +
                                '"] .editSectionBtn').attr('data-section-description', res.section
                                .section_description);
