                                ...
                                <div class="card-body">
                                    ...
                                    <form id="courseForm" type="POST">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" name="course_type">
                                                    ...
                                                    <option value="expert"
                                                        {{ $course->course_type == 'expert' ? 'selected' : '' }}>Expert
                                                        Course
                                                    </option>
                                                    <option value="public"
                                                        {{ $course->course_type == 'public' ? 'selected' : '' }}>Public
                                                        Course
                                                    </option>
                                                </select>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control"
                                                    placeholder="Enter video URL ( Youtube or Vimeo )" name="video_url"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <button type="submit" id="submitForm"
                                                    class="btn btn-lg btn-register">Update</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12 mb-3 d-flex align-items-center justify-content-between">
                                            ...
                                            <button class="btn btn-primary btn-sm add_sections_btn" data-course-id="{{ $course->id }}"><i class="fa fa-plus"></i> Add Sections</button>
                                        </div>
                                        <div class="col-12">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-danger" id="delSectionBtn">Delete</button>
            </div>
          </div>
        </div>
    </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea id="sectionDescription" class="form-control" cols="30" rows="5" placeholder="Enter Section Description"></textarea>
                </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="button" class="btn btn-primary" onclick="editSectionAction($(this))">Edit</button>
            </div>
          </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    <label for="addSectionTitle">Title</label>
                    <input type="text" class="form-control" id="addSectionTitle" name="section_title" placeholder="Enter Section Title">
                </div>
                <div class="form-group mb-3">
                    <label for="addSectionDescription">Description</label>
                    <textarea id="addSectionDescription" class="form-control" cols="30" rows="5" placeholder="Enter Section Description"></textarea>
                </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="button" class="btn btn-success" onclick="addSectionAction($(this))">Add</button>
            </div>
          </div>
        </div>
    </div>
          ...
          <div class="modal-content">
            ...
            <form id="add_single_lecture_form">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="add_lecture_title">Lecture Title</label>
                        <input type="text" class="form-control" id="add_lecture_title" name="lecture_title" placeholder="Enter Lecture Title">
                    </div>
                    <div class="form-group mb-3">
                        <label for="add_lecture_video">Lecture Video</label>
                        <input type="file" class="form-control" id="add_lecture_video" name="lecture_video" placeholder="Add Lecture Video">
                    </div>
                    <div class="form-group mb-3">
                        <label for="add_lecture_video_link">Lecture Video Link</label>
                        <input type="text" class="form-control" id="add_lecture_video_link" name="lecture_video_link" placeholder="Add Lecture Video Link">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-success" id="addLectureActionBtn">Add Lecture</button>
                </div>
            </form>
          </div>
        </div>
    ...
    <div class="modal fade" id="delLectureModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="button" class="btn btn-danger" onclick="delLectureAction($(this))">Delete</button>
            </div>
          </div>
        </div>
    </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Lecture Title" id="editLectureTitle">
                </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="button" class="btn btn-primary" onclick="editLectureAction($(this))">Edit</button>
            </div>
          </div>
        </div>
    </div>
