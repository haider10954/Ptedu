    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 table-responsive">
                <table class="table align-middle table-nowrap mb-0   border-white" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <td class="align-middle t_header">Section title</td>
                            <td class="align-middle t_header">Section Description</td>
                            <td class="align-middle t_header">No of Lectures</th>
                            <td class="align-middle t-header">Lectures</td>
                ...
                {{ $section->links('vendor.pagination.custom-pagination-admin') }}
