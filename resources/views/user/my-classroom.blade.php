                                            ...
                                            <div class="lecture_box_content">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between lecture-box-footer">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @if (!empty($first_lecture_slug))
                                                        <a href="{{ route('class', [$item->course_id, $first_lecture_slug]) }}" class="btn btn-primary btn-custom-sm btn-theme-blue">{{ __('translation.In Class') }}</a>
                                                        @else
                        ...
                        <div class="position-relative w-75 m-auto">
                            ...
                            <div class="position-absolute text-center w-100" style="padding: 10px 100px 10px 100px; top:15px;">
                                ...
                                <div class="certificate_description mb-1">
                                    Is hereby cetified as an <span id="c_name"></span> – <br /> <span id="t_name"></span> with Full Certification for the half-year period <br /> starting on
