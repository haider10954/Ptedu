                                ...
                                <div class="row progress_lectures_list">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12">
                                                <div class="lecture-box">
                                                    ...
                                                    <div class="lecture_box_content">
                                                        <h6 class="lecture_title">{{ $item->getCourses->course_title }}
                                                        </h6>
                                                        <small
                                    ...
                                    @else
                                        <div class="col-12 text-center">
                                            <img src="{{ asset('web_assets/images/no-data-found.png') }}" class="img-fluid"
                                                alt="img" style="height: 250px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
                                                    ...
                                                    <div class="lecture_box_content">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <button href="javascript:void(0)"
                                                                ...
                                                                data-course-name="{{ $v->getCourses->course_title }}"> <i
                                                                    class="fas fa-edit"></i>
                ...
                <div class="modal-body">
                            ...
                            <div class="position-relative w-75 m-auto">
                                ...
                                <div class="position-absolute text-center w-100"
                                    ...
                                    <div class="certificate_description mb-1">
                                        Is hereby cetified as an <span id="c_name"></span> – <br /> <span
                                            id="t_name"></span> with Full Certification for the half-year period <br />
                                        starting on
                                        <span id="certificate_start_date"></span> and ending on <span
                                            id="certificate_end_date"></span>
                                    </div>
                    ...
                    <div class="my-3 d-flex align-items-center justify-content-center">
                        <button type="button" id="download"
                            class="btn btn-primary mr-2 rounded-0 btn-theme-black">{{ __('translation.Download') }}</button>
