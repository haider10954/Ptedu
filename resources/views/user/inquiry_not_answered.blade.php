                    ...
                    <div class="custom-padding">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 col-9  pl-0">
                                <div class="d-flex align-items-center bottom-border"
                                    style="padding-left:10px; height:51px;">
                                    <div class="ml-2">
                                        <p class="mb-0">Name</p>
                                    </div>
                                </div>
                        ...
                        <div class="mt-5 top-border">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 col-9 pl-0">
                                    <div class="d-flex justify-content-start bottom-border"
                                        style="padding-left:10px; min-height:201px; width:100%">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="d-flex align-items-center justify-content-center mt-4">
                                        <a class="btn rounded-0 btn-theme-white" style="padding: 5px 30px 5px 30px"
                                            href="{{ route('user_inquiry') }}">Go to List </a>
                                    </div>
                                </div>
                            </div>
                        </div>
