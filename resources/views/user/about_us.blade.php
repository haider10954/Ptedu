        ...
        <div class="about_us_section_1" style="background-image: url('{{ asset('web_assets/images/aboutUs_1.png') }}')">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <h2 class="text-white mb-3"><img src="{{ asset('web_assets/images/PTEduLogo(AboutUs).png') }}">
                        </h2>
                        <p class="text-danger" style="margin-bottom: 3rem; font-size: 20px; font-weight: bold">Spreading
                            Proper Knowledge</p>
                    </div>
                    <div class="col-lg-12">
                        <div class="row align-items-start">
                            <div class="col-lg-6" style="border-right: 1px solid #343638">
                                <p class="mb-0 text-white font-25 padding-right-60">
                                    사람들에게 선한 영향력을 전달하기 위해 정진하는 모든 물리치료사들 및 운동 전문가들을 환영합니다. 피티에듀는 기초부터 심화 과정까지 올바른 지식을 통해
                                    전문가로 거듭남으로 형태의 변화에 대한 발판을 제공하는 교육 전문 플랫폼입니다.
                                </p>
                            </div>
                            <div class="col-lg-6">
                                <p class="mb-0 text-white font-25 padding-left-60">
                                    여러 치료사들이 모여 논문과 임상 경험을 베이스로 한 근거 기반 물리치료를 토대로 다양한 정보들을 선별하여 질높은 강의를 제공합니다. 분야별 맞춤식
                                    강의를 통해 개인의 역량을 더 나아가 건강한 대한민국을 만드는 데에 이바지합니다.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-100">
                    ...
                    <div class="row">
                        <div class="col-4 my-2">
                            <div>
                                <img src="{{asset('web_assets/images/aboutUs_4.png')}}" class="w-100 h-100"
                                     style="object-fit: cover">
                            </div>
                        </div>
                        <div class="col-4 my-2">
                            <div>
                                <img src="{{asset('web_assets/images/aboutUs_5.png')}}" class="w-100 h-100"
                                     style="object-fit: cover">
                            </div>
                        </div>
                        <div class="col-4 my-2">
                            <div>
                                <img src="{{asset('web_assets/images/aboutUs_6.png')}}" class="w-100 h-100"
                                     style="object-fit: cover">
                            </div>
                        </div>
                        <div class="col-4 my-2">
                            <div>
                                <img src="{{asset('web_assets/images/aboutUs_7.png')}}" class="w-100 h-100"
                                     style="object-fit: cover">
                            </div>
                        </div>
                        <div class="col-4 my-2">
                            <div>
                                <img src="{{asset('web_assets/images/aboutUs_8.png')}}" class="w-100 h-100"
                                     style="object-fit: cover">
                            </div>
                        </div>
                        <div class="col-4 my-2">
                            <div>
                                <img src="{{asset('web_assets/images/aboutUs_9.png')}}" class="w-100 h-100"
                                     style="object-fit: cover">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <div class="h-100">
                                <img src="{{asset('web_assets/images/aboutUs_10.png')}}" class="w-100 h-100"
                                     style="object-fit: cover">
                            </div>
                        </div>
                        <div class="col-8">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-2">
                                        <img src="{{asset('web_assets/images/aboutUs_11.png')}}" class="w-100 h-100"
                                             style="object-fit: cover">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div>
                                        <img src="{{asset('web_assets/images/aboutUs_12.png')}}" class="w-100 h-100"
                                             style="object-fit: cover">
