                            ...
                            @if (!empty($reservation))
                                @if ($reservation->status == 'decline')
                                    <div class="badge  mt-3 mb-3 p-2"
                                        style="background: #F9DFDF; border-radius: 2px; color: #791919;">
                        ...
                        @else
                            @if ($offline_enrollment_count >= $course_info->no_of_enrollments)
                                <div class="badge  mt-3 mb-3 p-2"
                                    ...
                                    {{ __('translation.please login to submit application') }}.</div>
                            @endif
                        @endif
                ...
                {{-- <ul class="nav nav-pills mb-40 nav_tabs" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                            ...
                            aria-selected="false">{{ __('translation.Instructor Introduction') }}</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary" href="javascript:void(0)"
                        id="confirmReservation">{{ __('translation.Save changes') }}</a>
    ...
    <div class="modal" id="enrollmentModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary" href="javascript:void(0)"
                        id="confirmEnrollment">{{ __('translation.Apply') }}</a>
                    <button type="button" class="btn btn-secondary"
                        data-dismiss="modal">{{ __('translation.Close') }}</button>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        <a class="btn btn-primary" href="javascript:void(0)"
                            id="delReservation">{{ __('translation.Save changes') }}</a>
                        <button type="button" class="btn btn-secondary"
                            data-dismiss="modal">{{ __('translation.Close') }}</button>
                    </div>
                </form>
