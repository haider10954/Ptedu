                    ...
                    <li class="nav-link" style="--i: 1.35s">
                        <ul>
                            <li class="nav-link has-megamenu" style="--i: 1.1s">
                                <a href="javascript:void(0)" class="text-decoration-none">{{ __('translation.Review') }}</a>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <ul class="mb-0 px-0">
                                                        <li>
                                                            <a href="{{ route('offline_review') }}" class="text-decoration-none" style="color: black !important;">오프라인 검토</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
