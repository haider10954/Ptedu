                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex  align-content-center justify-content-center mt-3">
                                <a href="{{ route('web-home') }}" class="btn btn-theme-delete mx-2"><span class="mr-2">{{ __('translation.View other courses') }}</span> <i class="fa fa-angle-right"></i> </a>
...
@section('modals')
<div class="modal fade review_modal" id="delModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-custom" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title d-flex align-items-center" id="exampleModalLabel"><i class="fas fa-exclamation text-dark"></i> <span>{{ __('translation.Confirm Delete') }}</span>
                </h5>
            </div>
            <div class="modal-body">
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <button type="submit" id="submitForm" class="btn btn-primary mr-2 rounded-0 btn-theme-black">{{ __('translation.Delete') }}</button>
